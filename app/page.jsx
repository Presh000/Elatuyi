  ...
  return (
    <section className="w-full flex-center flex-col  px-5 ">
      <div className=" grid lg:grid-cols-2 gap-12 items-center ">
        ...
        />
        <div>
          <p className="home_text text-[20px] md:text-[21px] lg:text-[18px] xl:text-[20px] leading-8 md:leading-8  lg:leading-7 xl:leading-8  ">
          ...
          <p className="home_text text-[20px] md:text-[21px] lg:text-[18px] xl:text-[20px] leading-8 md:leading-8  lg:leading-7 xl:leading-8">
            ...
            roles, the companies include Reckitt Benckiser, Guinness and Pladis
            global.
          </p>
          <p className="home_text text-[20px] md:text-[21px] lg:text-[18px] xl:text-[20px] leading-8 md:leading-8  lg:leading-7 xl:leading-8">
            {" "}
